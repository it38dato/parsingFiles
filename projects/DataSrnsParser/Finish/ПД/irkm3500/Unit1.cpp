...
//                        out << b << endl; // выводим первую строчную инфу через строку
                        ...
                        a ="";
                        if(b.size()>=65){
                                a=b.substr(65,15); // выделяем нужную ПД
...
//////// выводим красиво теперь
        for(int j=0; j<Sputnik.size(); j++) {
                out << setw(15) << Sputnik[j] << " "; // выводим названия спутников в строку
        }
        out << endl;
        
        for(int i=0; i<info.size(); i++) {
                for(int j=0; j<info[i].size(); j++) {
                        out << setw(15)  << setprecision(15) << info[i][j] << " "; // выводим ПД в строку и сортируем с ПД
                }
                out << endl;
        }
        out << endl;
